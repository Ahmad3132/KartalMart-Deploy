    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#1a2b4b] flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          <img src={kartalLogo} alt="Kartal" className="h-32 object-contain mb-6 drop-shadow-2xl" style={{ filter: 'brightness(0) invert(1)' }} />
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex flex-col items-center mb-8">
            <img src={kartalLogo} alt="Kartal" className="h-16 object-contain mb-3" />
